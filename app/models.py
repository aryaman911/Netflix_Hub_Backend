...
class ADPAccount(Base):
    ...
    monthly_service_fee = Column(Numeric(10,2), nullable=False, default=9.99)
    adp_country_country_code = Column(String(10), ForeignKey("adp_country.country_code"), nullable=False)
